...
export type Featurecard = {id:number,title: string, description:string, icon:string, details:string};
export type Reasoncard = {id:number,title: string, description:string, icon:LucideIcon};
