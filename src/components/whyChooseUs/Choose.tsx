            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 rounded-full bg-blue-100 bg-gradient-to-b from-black to-[#0de4d6] text-transparent bg-clip-text">
                    <Icon size={24} />
                  </div>
                  <h3 className="text-lg font-semibold bg-gradient-to-b from-black to-[#0de4d6] text-transparent bg-clip-text">
                    {reason.title}
                  </h3>
                </div>
